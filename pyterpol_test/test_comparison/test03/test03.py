...
obs = [
       dict(filename='o.asc',  error=0.01, korel=True, component='primary', group={'rv':1}),
...
sl.add_component(component='secondary', teff=10000., logg=4.5, rv=30., vrot=10., lr=0.5, z=1.0)
