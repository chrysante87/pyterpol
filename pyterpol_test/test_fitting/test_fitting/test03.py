...
sl.add_component(component='primary', teff=16000., logg=4.5, rv=10., z=1.0, vrot=50.0, lr=0.3)
sl.add_component(component='secondary', teff=24000., logg=4.5, rv=10., z=1.0, vrot=150.0, lr=0.7)
...
itf.set_parameter(parname='logg', component='primary', fitted=True)
fitpars = itf.get_fitted_parameters()
# itf.sl.get_fitted_types()
print itf.sl.fitted_types
