...
sl.add_component(component='primary', teff=18000., logg=4.2, rv=0., z=1.0, vrot=50.0, lr=0.3)
sl.add_component(component='secondary', teff=20000., logg=3.6, rv=0., z=1.0, vrot=120.0, lr=0.7)
